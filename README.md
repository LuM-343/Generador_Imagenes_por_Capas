...
* **Listas Enlazadas:** Una Lista Circular Doblemente Enlazada administra el catálogo de imágenes[cite: 93]. [cite_start]Listas simples enlazan las dependencias de capas utilizando apuntadores en lugar de duplicar datos.
